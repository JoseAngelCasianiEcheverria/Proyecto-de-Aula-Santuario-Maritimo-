...
public class GestionVigilantes extends javax.swing.JFrame {
    ...
    private Stack<Vigilantes> pilaEliminacion = new Stack<>();
    ...
    private void guardarRegistroVigilante(){
        try {
            ...
            Vigilantes nuevoVigilante = new Vigilantes(cargo, fechaContratacion, salario, horario, correo, numTelefono, nombre, apellido, genero, edadIngresada, iD, area);
    ...
    private void cargarTablaVigilantes(){
        ...
        Collections.sort(listaVigilantes, Comparator.comparing(Vigilantes::getNombre, String.CASE_INSENSITIVE_ORDER));
    ...
    private void eliminarVigilantes(){
        ...
        if (iDIngresado != null && !iDIngresado.trim().isEmpty()) {
            try {
                ...
                Vigilantes vigilanteEliminado = dao.buscarConID(id);
                
                if (vigilanteEliminado == null) {
                    JOptionPane.showMessageDialog(this,"Vigilante no existente","Warning",JOptionPane.WARNING_MESSAGE);
                    return;
                    
                }
                pilaEliminacion.push(vigilanteEliminado);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTION VIGILANCIA");
        ...
        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/MARINUS MEJORADO IA (1) (1)-artguru (1).png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addComponent(btnRgreso, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(53, 53, 53)
        ...
        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/ORDENAR (1).png"))); // NOI18N
        jLabel22.setText("ORDENAR LISTA");
        ...
        btnRestaurar.setBackground(new java.awt.Color(0, 204, 0));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/VIGILANTE 1 MEJORADO IA (1).png"))); // NOI18N

        jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/VIGILANTE 3 MEJORADO IA (1).png"))); // NOI18N

        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/VIGILANTE 4 MEJORADO IA (1) (1).png"))); // NOI18N
    ...
    private void btnOrdenamientoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOrdenamientoMouseClicked
        ...
        filas.sort((a,b) -> {
            try {
                ...
                Date fecha1 = format.parse(a[10].toString());
    ...
    private void btnRestaurarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRestaurarMouseClicked
        ...
        Vigilantes recuperado = pilaEliminacion.pop();
        dao.guardarVigilantes(recuperado);
        cargarTablaVigilantes();
        
        JOptionPane.showMessageDialog(this,"Vigilante "+ recuperado.getNombre() + " recuperado exitosamente","Exitos",JOptionPane.INFORMATION_MESSAGE);
