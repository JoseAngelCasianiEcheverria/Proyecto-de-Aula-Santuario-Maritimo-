...
public class GestionCuidadores extends javax.swing.JFrame {
    ...
    private Stack<Cuidadores> pilaEliminacion = new Stack<>();
    ...
    private void cargarTablaCuidadores(){
        ...
        Collections.sort(listaCuidadores, Comparator.comparing(Cuidadores::getNombre, String.CASE_INSENSITIVE_ORDER));
    ...
    private void eliminarCuidadores(){
        ...
        if (iDIngresado != null && !iDIngresado.trim().isEmpty() ) {
            try {
                ...
                Cuidadores cuidadorEliminado = dao.buscarConID(id);
                
                if (cuidadorEliminado == null) {
                    JOptionPane.showMessageDialog(this,"Cuidador no existente","Warning",JOptionPane.WARNING_MESSAGE);
                    return;  
                }
                
                pilaEliminacion.push(cuidadorEliminado);
                dao.eliminarConID(id);
                cargarTablaCuidadores();
                
                JOptionPane.showMessageDialog(this,"Registro eliminado y guardado en una pila en caso de restauracion","Exitos",JOptionPane.INFORMATION_MESSAGE);
 ...
 private void actualizarCuidadores() {
    ...
    private void initComponents() {
        ...
        botonRestauracion = new javax.swing.JPanel();
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/MARINUS MEJORADO IA (1) (1)-artguru (1).png"))); // NOI18N
        ...
        botonRestauracion.setBackground(new java.awt.Color(0, 204, 0));
        botonRestauracion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                botonRestauracionMouseClicked(evt);
            }
        });
        ...
        jLabel28.setText("RESTAURAR");

        javax.swing.GroupLayout botonRestauracionLayout = new javax.swing.GroupLayout(botonRestauracion);
        botonRestauracion.setLayout(botonRestauracionLayout);
        botonRestauracionLayout.setHorizontalGroup(
            botonRestauracionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 173, Short.MAX_VALUE)
            .addGroup(botonRestauracionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(botonRestauracionLayout.createSequentialGroup()
                    .addGap(0, 49, Short.MAX_VALUE)
                    .addComponent(jLabel28)
                    .addGap(0, 49, Short.MAX_VALUE)))
        );
        botonRestauracionLayout.setVerticalGroup(
            botonRestauracionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 43, Short.MAX_VALUE)
            .addGroup(botonRestauracionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(botonRestauracionLayout.createSequentialGroup()
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/CUIDADOR 1 MEJORADO IA (1) (1).png"))); // NOI18N
        jLabel16.setText("jLabel16");

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/CUIDADOR 2 MEJORADO IA (1).png"))); // NOI18N

        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/CUIDADOR 3 MEJORADO IA 3.png"))); // NOI18N
        jLabel19.setText("jLabel19");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/CUIDADOR 4 MEJORADO IA (1).png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(botonRestauracion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnOrdenarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOrdenarMouseClicked
        ...
        filas.sort((a,b) -> {
            try {
                ...
                Date fechaa1 = format.parse(a[10].toString());
                Date fecha2 = format.parse(b[10].toString());
                return fechaa1.compareTo(fecha2);
        ...
        JOptionPane.showMessageDialog(this, "Registros ordenados por fecha", "Éxitos", JOptionPane.INFORMATION_MESSAGE);
        
        
        
    }//GEN-LAST:event_btnOrdenarMouseClicked

    private void botonRestauracionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonRestauracionMouseClicked
        // TODO add your handling code here:
        if (pilaEliminacion.isEmpty()) {
            JOptionPane.showMessageDialog(this,"Esta pila esta vacia","Warning",JOptionPane.WARNING_MESSAGE);
            return;
            
        }
        Cuidadores restaurado = pilaEliminacion.pop();
        dao.guardarCuidador(restaurado);
        cargarTablaCuidadores();
        
        JOptionPane.showMessageDialog(this,"cuidador " + restaurado.getNombre() + " restaurado exitosamente","Exitos",JOptionPane.INFORMATION_MESSAGE);
        
        
    }//GEN-LAST:event_botonRestauracionMouseClicked
    ...
    private javax.swing.JPanel botonRestauracion;
